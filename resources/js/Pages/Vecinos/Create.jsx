        ...
        <AppLayout title="Nuevo Vecino">
            ...
            <div className="max-w-3xl">
                <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="md:col-span-2">
                                <Field label="Nombres y Apellidos" error={errors.nombres_apellidos}>
                                    <input
                                        type="text"
                                        value={data.nombres_apellidos}
                                        onChange={e => setData('nombres_apellidos', e.target.value)}
                            ...
                            <Field label="Comuna de Residencia" error={errors.comuna_residencia}>
                                <input
                                    type="text"
                                    value={data.comuna_residencia}
                                    onChange={e => setData('comuna_residencia', e.target.value)}
                                    className={inputClass}
                                />
                            </Field>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="space-y-4">
                            <Field label="Medio por el que se enteró" error={errors.como_se_entero}>
                                <input
                                    type="text"
                                    value={data.como_se_entero}
                                    onChange={e => setData('como_se_entero', e.target.value)}
                                    placeholder="Ej: referido, publicidad, etc."
                                    className={inputClass}
                                />
                            </Field>
                            <Field
                                label="Indicar medio (si corresponde)"
                                hint="Página web o Red Social"
                                error={errors.medio_difusion}
                            >
                                <input
                                    type="text"
                                    value={data.medio_difusion}
                                    onChange={e => setData('medio_difusion', e.target.value)}
                                    placeholder="Ej: Instagram, sitio web, Facebook…"
                                    className={inputClass}
                                />
                            </Field>
                        </div>
                    ...
                    {/* Sección 3 - Contacto con vendedor */}
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="space-y-4">
                            <Field label="Nombre del vendedor/a con quien se contactó" error={errors.contacto_vendedor_nombre}>
                                <input
                                    type="text"
                                    value={data.contacto_vendedor_nombre}
                                    onChange={e => setData('contacto_vendedor_nombre', e.target.value)}
                                    className={inputClass}
                                />
                            </Field>
                            <Field label="Medio por el que se contactó con el/la vendedor/a" error={errors.medio_contacto_vendedor}>
                                <input
                                    type="text"
                                    value={data.medio_contacto_vendedor}
                                    onChange={e => setData('medio_contacto_vendedor', e.target.value)}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <Field label="Valor del terreno" error={errors.valor_terreno}>
                                <input
                                    ...
                                    onChange={e => setData('valor_terreno', e.target.value)}
                                    placeholder="0.00"
                                    className={inputClass}
                                />
                            </Field>
                            ...
                            <div className="md:col-span-2">
                                <Field label="Datos de la cuenta a la que se realizó el pago" error={errors.datos_cuenta_pago}>
                                    <textarea
                                        value={data.datos_cuenta_pago}
                                        onChange={e => setData('datos_cuenta_pago', e.target.value)}
                                        rows={3}
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <Field
                            label="Plazo para el pago y fecha de entrega del terreno"
                            error={errors.plazo_pago_entrega}
                        >
                            <textarea
                                value={data.plazo_pago_entrega}
                                onChange={e => setData('plazo_pago_entrega', e.target.value)}
                                rows={3}
                                className={textareaClass}
                            />
                        </Field>
                    ...
                    {/* Sección 6 - Registro de pagos */}
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        <SectionTitle number="6" title="Registro de pagos" />
                        <Field
                            label="¿Mantiene registro de los pagos realizados?"
                            hint="Comprobantes o plataforma virtual donde quedan registrados"
                            error={errors.registro_pagos}
                        >
                            <textarea
                                value={data.registro_pagos}
                                onChange={e => setData('registro_pagos', e.target.value)}
                                rows={3}
                                className={textareaClass}
                            />
                        </Field>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        <Field label="Estado de la Parcela" error={errors.estado_parcela}>
                            <input
                                type="text"
                                value={data.estado_parcela}
                                onChange={e => setData('estado_parcela', e.target.value)}
                                placeholder="Ej: entregada, pendiente, en proceso…"
                                className={inputClass}
                            />
                        </Field>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            {processing ? 'Guardando…' : 'Guardar vecino'}
                        </button>
